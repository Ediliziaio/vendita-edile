      ...
      <div className="container-narrow relative z-10">
        ...
        <AnimatedSection delay={0.15}>
          <div className="text-center mb-12">
            <h2 className="heading-section text-foreground mb-4">
              È <span className="text-gold glow-gold">AFFIANCAMENTO OPERATIVO</span>
            </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-6 md:p-8 bg-background border-2 border-destructive/30 rounded-2xl relative overflow-hidden"
          >
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="p-6 md:p-8 bg-gold/5 border-2 border-gold rounded-2xl relative overflow-hidden"
          >
        ...
        >
          ...
          <div className="relative p-8 md:p-10 bg-background border-2 border-gold rounded-2xl text-center">
