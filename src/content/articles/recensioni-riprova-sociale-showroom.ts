...
const article: Article = {
  slug: "recensioni-riprova-sociale-showroom",
  title: "Recensioni e riprova sociale: come farle diventare vendite in showroom",
  metaTitle: "Recensioni Impresa Edile: Guida alla Riprova Sociale 2025",
  metaDescription:
    "Come usare le recensioni impresa edile per vendere di più: quando chiederle, dove raccoglierle, come rispondere e come usarle in trattativa e sul sito.",
  excerpt:
  ...
  content: `## Perché le recensioni fanno vendere di più (e non sono solo "immagine")
...
La riprova sociale ti riempie il funnel di clienti già predisposti a fidarsi. Ma trasformare quella fiducia in un contratto firmato, senza abbassare il prezzo, resta un lavoro di vendita vero: qualifica, diagnosi, presentazione a valore, gestione delle obiezioni. È esattamente quello che alleniamo in **VENDITA EDILE®**, affiancando i commerciali sul campo, non in aula. Se vuoi vedere come applicarlo alla tua impresa, [candidati qui](/#candidati).`,
  faq: [
    {
      question: "Come si chiedono le recensioni a un cliente edile senza sembrare invadenti?",
      answer:
    ...
    {
      question: "Quante recensioni servono per un'impresa edile per farsi scegliere?",
      answer:
    ...
    {
      question: "Perché le recensioni Google sono più importanti di Facebook per un'impresa edile?",
      answer:
    ...
    {
      question: "Come si risponde a una recensione negativa senza peggiorare la situazione?",
      answer:
    ...
    {
      question: "Le foto dei cantieri aiutano davvero a vendere di più?",
      answer:
