...
const article: Article = {
  ...
  title: "Vendere senza fare sconti: come chiudere a prezzo pieno nell'edilizia",
  metaTitle: "Vendere Senza Fare Sconti: Guida per Imprese Edili 2026",
  metaDescription:
    "Vendere senza fare sconti si può: scopri quanto ti costa davvero un 10% di sconto e le alternative concrete per chiudere a prezzo pieno. Guida pratica.",
  excerpt:
  ...
  content: `## Si può vendere senza fare sconti nell'edilizia? Sì, e conviene sempre
...
Se vuoi che questo diventi un metodo strutturato per te e per la tua squadra commerciale, non solo un'idea buona letta in un articolo, è esattamente il lavoro che facciamo dentro **VENDITA EDILE®**: affiancamento reale sul campo, sui tuoi preventivi veri, con i tuoi commerciali veri. Perché vendere senza fare sconti non è questione di carattere. È questione di metodo.`,
  faq: [
    {
      question: "Come si fa a vendere senza fare sconti nell'edilizia?",
      answer:
    ...
    {
      question: "Quanto costa davvero uno sconto del 10% sul margine di un preventivo?",
      answer:
    ...
    {
      question: "Perché il cliente chiede sempre l'ultimo sconto anche se il prezzo è corretto?",
      answer:
    ...
    {
      question: "Cosa rispondere quando il cliente dice di avere un preventivo più basso?",
      answer:
    ...
    {
      question: "Quali alternative allo sconto funzionano meglio nell'edilizia?",
      answer:
    ...
    {
      question: "Fare sempre sconti danneggia l'impresa nel lungo periodo?",
      answer:
