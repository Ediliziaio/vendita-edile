...
const article: Article = {
  ...
  title: "Perché perdi clienti dopo il preventivo (e non è il prezzo)",
  metaTitle: "Perdere Clienti Preventivi: le 6 Vere Cause (e Soluzioni)",
  metaDescription:
    "Perdere clienti sui preventivi non dipende quasi mai dal prezzo. Scopri le 6 cause reali (lentezza, follow-up, WhatsApp senza spiegazione) e come risolverle.",
  excerpt:
  ...
  content: `## Perché perdi clienti sui preventivi: la risposta diretta
...
Se vuoi mettere questo sistema in piedi davvero, con la tua squadra e i tuoi numeri reali, è esattamente il lavoro che facciamo dentro **VENDITA EDILE®**: affiancamento pratico sul campo, non un corso da guardare in differita. Scopri come funziona e [candidati qui](/#candidati): il primo passo per smettere di perdere clienti sui preventivi che ti stanno già chiedendo un sì.`,
  faq: [
    {
      question: "Perché perdo clienti dopo aver fatto un preventivo corretto?",
      answer:
    ...
    {
      question: "Quanto tempo dovrei impiegare per mandare un preventivo dopo il sopralluogo?",
      answer:
    ...
    {
      question: "Come si fa un follow-up efficace su un preventivo inviato?",
      answer:
    ...
    {
      question: "Perché mandare il preventivo solo su WhatsApp fa perdere clienti?",
      answer:
    ...
    {
      question: "Come faccio a smettere di perdere clienti per disorganizzazione interna?",
      answer:
    ...
    {
      question: "Il concorrente più economico mi porta via i clienti: cosa posso fare?",
      answer:
