...
const article: Article = {
  ...
  title: "Obiezione \"ci penso\": come gestirla e chiudere più preventivi di infissi",
  metaTitle: "Obiezione Ci Penso: Come Gestirla Senza Perdere il Cliente",
  metaDescription:
    "Obiezione ci penso: cosa significa davvero, come prevenirla in trattativa e le domande giuste per farla emergere. Guida pratica con script ed esempi.",
  excerpt:
  ...
  cover,
  keyTakeaways: [
    "L'obiezione ci penso quasi mai significa che il cliente vuole davvero riflettere: nella maggior parte dei casi nasconde un dubbio non detto, un prezzo non giustificato o una decisione che non spetta solo a lui.",
    "Si previene molto prima che arrivi, qualificando il cliente e costruendo valore durante il sopralluogo, non alla fine quando presenti il numero.",
    "La domanda che fa emergere il vero motivo è una sola: \"cosa la frena esattamente, così posso aiutarla a valutare meglio?\".",
    "Un preventivo che finisce in ci penso non è perso: l'80% delle chiusure tardive arriva tra il secondo e il quarto contatto, se il follow-up è strutturato.",
    "Rincorrere il cliente con \"ha deciso?\" non funziona: bisogna tornare con un contenuto di valore, non con una richiesta di risposta.",
  ],
  content: `## Cosa significa davvero quando un cliente dice "ci devo pensare"
...
| Cosa nasconde il "ci penso" | Segnale da notare | Come rispondere |
| --- | --- | --- |
| Il prezzo non è ancora giustificato dal valore percepito | Ha guardato subito il totale, poco interesse ai dettagli tecnici | Torna sul beneficio concreto: risparmio in bolletta, comfort, silenzio. Non abbassare il prezzo, alza il valore |
| Deve decidere con qualcuno che non è presente (coniuge, socio) | Frasi tipo "devo sentire mia moglie", sguardi verso il telefono | Chiedi di coinvolgere subito chi manca, anche per telefono, o fissa un secondo incontro con entrambi |
| Non si fida ancora di te o dell'azienda | Domande su referenze, garanzie, tempi di consegna ripetute più volte | Porta prove concrete: cantieri fatti nella zona, recensioni, garanzia scritta nero su bianco |
| Sta confrontando con altri preventivi | Chiede "e se trovo di meno?" o menziona altri contatti | Fai emergere cosa NON è incluso negli altri preventivi: posa, materiali, assistenza |
| Ha davvero bisogno di più tempo (budget, ristrutturazione più ampia) | Parla di tempistiche, lavori collegati, priorità in cantiere | Rispetta i tempi ma fissa già una data di richiamo precisa, non generica |
...
- "Tra tutto quello che le ho mostrato, c'è qualcosa che non la convince del tutto?"
- "Se il prezzo non fosse un problema, firmerebbe oggi? Mi aiuta a capire su cosa concentrarmi."
- "Cosa dovrei dirle o mostrarle in più perché possa decidere con serenità oggi stesso?"
...
- Prima di presentare il prezzo, verifica di aver fatto emergere il vero problema del cliente, non solo la misura degli infissi.
- Scrivi e memorizza la domanda "cosa la frena esattamente?" e usala ogni volta che senti arrivare un "ci penso".
- Prepara in anticipo le risposte alle tre cause più frequenti del rinvio nella tua zona: prezzo, decisore assente, confronto con altri preventivi.
- Metti in agenda, per ogni preventivo che finisce in "ci penso", i quattro contatti di follow-up con le rispettive date, non un generico "richiamare".
...
Se vuoi che la gestione delle obiezioni, il "ci penso" incluso, diventi un sistema replicabile da tutta la tua squadra commerciale e non solo un'intuizione tua personale, è esattamente il lavoro che facciamo in **VENDITA EDILE®**: affiancamento diretto sul campo, sulle tue trattative vere, non teoria da corso online. Perché un'obiezione gestita bene non è fortuna: è metodo che si insegna e si ripete.`,
  faq: [
    {
      question: "Come si gestisce l'obiezione ci penso in una trattativa di infissi?",
      answer:
    ...
    {
      question: "Perché il cliente dice sempre ci devo pensare anche se sembra interessato?",
      answer:
    ...
    {
      question: "Quanto tempo bisogna aspettare prima di richiamare un cliente che ha detto ci penso?",
      answer:
    ...
    {
      question: "Come si previene l'obiezione ci penso prima che arrivi?",
      answer:
    ...
    {
      question: "Cosa fare se il cliente resta vago anche dopo aver chiesto cosa lo frena?",
      answer:
    ...
    {
      question: "Il ci penso significa sempre che il prezzo è troppo alto?",
      answer:
