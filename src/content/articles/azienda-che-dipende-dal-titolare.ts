...
import cover from "@/assets/cover-azienda-che-dipende-dal-titolare.webp";

const article: Article = {
  slug: "azienda-che-dipende-dal-titolare",
  title: "Azienda che dipende dal titolare: come uscire dalla trappola e vendere senza di te",
  metaTitle: "Azienda che Dipende dal Titolare: Come Uscirne (Guida)",
  metaDescription:
    "Hai un'azienda che dipende dal titolare e senza di te si ferma tutto? Ecco perché succede e il sistema per delegare vendita e chiusure senza perdere fatturato.",
  excerpt:
  ...
  cover,
  keyTakeaways: [
    "Un'azienda che dipende dal titolare è un'azienda che vale zero senza di lui: se il fatturato crolla quando sei in ferie, non hai costruito un'impresa, hai costruito un lavoro autonomo travestito da SRL.",
    "Il costo nascosto della dipendenza dal titolare si misura in preventivi persi, crescita bloccata e un tetto di fatturato legato alle tue ore disponibili, non al mercato.",
    "Il tuo modo di vendere può diventare un sistema replicabile: script, criteri di qualifica, gestione obiezioni e follow-up scritti e trasferibili a un commerciale.",
    "Formare commerciali che chiudono come te richiede affiancamento sul campo, non un corso teorico: si impara vendendo davanti al cliente, con correzione immediata.",
    "Delegare la vendita non significa perdere il controllo del fatturato: significa passare da produttore di ogni singolo preventivo a proprietario di un processo che produce preventivi chiusi anche senza di te.",
  ],
...
| Indicatore | Azienda che dipende dal titolare | Azienda con sistema di vendita |
|---|---|---|
| Preventivi gestibili al mese | 15-20 (limite: le tue ore) | 40-60 (limite: il mercato) |
| Tasso di chiusura senza il titolare | 5-10% | 30-40% |
| Fatturato in ferie/malattia del titolare | Crolla o si ferma | Continua a crescere |
| Valore dell'azienda in caso di vendita | Basso, dipende da una persona | Alto, è un processo replicabile |
| Tempo libero reale del titolare | Quasi zero | Recuperabile in 6-12 mesi |
...
- Una **checklist di qualifica** che chiunque risponda al telefono può usare per capire se vale la pena fissare il sopralluogo.
- Un **listino con margini già definiti** e sconti massimi autorizzati, così il commerciale non deve chiedere il tuo ok ogni volta.
- Una **scaletta di presentazione del preventivo** che guida anche chi è alle prime armi.
- Un **piano di follow-up automatico**, con tempistiche fisse (48 ore, una settimana, un mese), così nessun preventivo muore per dimenticanza.
...
- Scrivi oggi le 5 fasi del tuo processo di vendita, anche in modo grezzo: qualifica, diagnosi, presentazione, obiezioni, follow-up.
...
È esattamente il lavoro che facciamo dentro **VENDITA EDILE®**: non un corso da guardare, ma un affiancamento sul campo che trasforma il tuo modo di vendere in un sistema che i tuoi commerciali possono usare, con te che torni a fare l'imprenditore invece del venditore di ultima istanza. Se vuoi capire se il tuo caso è adatto, [candidati qui](/#candidati) e ne parliamo direttamente.`,
  faq: [
    {
      question: "Come faccio a capire se ho un'azienda che dipende dal titolare?",
      answer:
    ...
    {
      question: "Quanto costa davvero un'azienda che dipende dal titolare?",
      answer:
    ...
    {
      question: "Perché 'faccio prima da solo' è un problema se funziona nel breve termine?",
      answer:
    ...
    {
      question: "Come si trasforma il proprio modo di vendere in un sistema replicabile?",
      answer:
    ...
    {
      question: "Come si formano commerciali che chiudono come il titolare?",
      answer:
    ...
    {
      question: "Quanto tempo serve per uscire da un'azienda che dipende dal titolare?",
      answer:
