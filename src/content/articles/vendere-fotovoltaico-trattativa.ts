...
import cover from "@/assets/cover-vendere-fotovoltaico-trattativa.webp";

const article: Article = {
  slug: "vendere-fotovoltaico-trattativa",
  title: "Come vendere il fotovoltaico in trattativa senza svenderlo",
  metaTitle: "Vendere Fotovoltaico in Trattativa: Guida Pratica 2025",
  metaDescription:
    "Come vendere fotovoltaico senza fare sconti: vendi risparmio e ROI, non Watt. Numeri semplici, obiezioni gestite, incentivi usati bene. Guida operativa.",
  excerpt:
  ...
  content: `## Perché vendi fotovoltaico e finisci sempre a fare sconti
...
Se vuoi il sistema completo applicato alla tua azienda, ai tuoi commerciali e ai tuoi impianti reali, è esattamente il lavoro che facciamo in **VENDITA EDILE®**: affiancamento sul campo, trattativa per trattativa, non un corso da guardare in differita. [Candidati qui](/#candidati) e vediamo insieme dove stai lasciando margine sul tavolo.`,
  faq: [
    ...
    {
      question: "Quanto conviene davvero installare il fotovoltaico?",
      answer:
    ...
    {
      question: "Cosa rispondere se il cliente dice che il fotovoltaico costa troppo?",
      answer:
    ...
    {
      question: "Se cambiano gli incentivi, l'investimento nel fotovoltaico perde valore?",
      answer:
    ...
    {
      question: "Quanto dura un impianto fotovoltaico con accumulo?",
      answer:
    ...
    {
      question: "Perché la riprova sociale è importante per vendere fotovoltaico?",
      answer:
