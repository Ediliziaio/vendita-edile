...
import cover from "@/assets/blog-clienti-qualificati-edilizia.jpg";

const article: Article = {
  slug: "clienti-qualificati-edilizia",
  title: "Clienti qualificati edilizia: come smettere di rincorrere i curiosi",
  metaTitle: "Clienti Qualificati Edilizia: Come Riconoscerli Subito",
  metaDescription:
    "Clienti qualificati edilizia: i 3 criteri per riconoscerli al primo contatto, il posizionamento che li attira e come dire no ai curiosi. Guida pratica.",
  excerpt:
  ...
  content: `## Cosa significa davvero "cliente qualificato" in edilizia
...
Se vuoi costruire un sistema di qualifica strutturato, applicato alla tua azienda e ai tuoi commerciali, è esattamente il lavoro che facciamo in **VENDITA EDILE®**: affiancamento sul campo, non teoria da corso. Scopri come [candidarti al programma](/#candidati) e smetti di rincorrere i curiosi.`,
  faq: [
    {
      question: "Come si riconosce un cliente qualificato in edilizia?",
      answer:
    ...
    {
      question: "Quanto tempo si perde con i clienti non qualificati?",
      answer:
    ...
    {
      question: "Perché abbassare i prezzi non porta più clienti qualificati?",
      answer:
    ...
    {
      question: "Come faccio a dire di no a un cliente senza perdere il contatto?",
      answer:
    ...
    {
      question: "Il posizionamento influisce davvero sul tipo di clienti che arrivano?",
      answer:
    ...
    {
      question: "Qual è il primo passo per iniziare a qualificare meglio i clienti?",
      answer:
