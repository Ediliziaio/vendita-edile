...
import cover from "@/assets/cover-aumentare-prezzo-medio-edilizia.webp";

const article: Article = {
  slug: "aumentare-prezzo-medio-edilizia",
  title: "Come aumentare il prezzo medio in edilizia (senza perdere clienti)",
  metaTitle: "Aumentare Prezzo Medio in Edilizia: Guida Pratica",
  metaDescription:
    "Come aumentare il prezzo medio in edilizia con upsell e cross-sell intelligenti, senza spaventare il cliente. Metodo, esempi numerici e passi pratici.",
  excerpt:
  ...
  content: `## Come si aumenta il prezzo medio in edilizia
...
Se vuoi costruire questo sistema dentro la tua azienda, con i tuoi prodotti e i tuoi commerciali, è esattamente il lavoro che facciamo in **VENDITA EDILE®**: non un corso da guardare, ma un affiancamento sul campo per alzare il tasso di chiusura e il prezzo medio insieme, senza abbassare mai i prezzi. [Candidati qui](/#candidati) se vuoi vedere se fa al caso tuo.`,
  faq: [
    {
      question: "Come si aumenta il prezzo medio in edilizia senza perdere clienti?",
      answer:
    ...
    {
      question: "Quanto si può alzare il ticket medio in un'impresa edile?",
      answer:
    ...
    {
      question: "Quali sono i migliori upsell da proporre con gli infissi?",
      answer:
    ...
    {
      question: "Perché la logica buono-migliore-ottimo fa aumentare le vendite?",
      answer:
    ...
    {
      question: "L'aumento del prezzo medio conviene più dell'acquisizione di nuovi clienti?",
      answer:
    ...
    {
      question: "Come si propone un upsell senza sembrare invadenti con il cliente?",
      answer:
