...
const article: Article = {
  slug: "negoziazione-senza-cedere-sul-prezzo",
  title: "Negoziazione del prezzo: come trattare col cliente senza cedere",
  metaTitle: "Negoziazione Prezzo Edilizia: Trattare Senza Cedere",
  metaDescription:
    "Negoziazione prezzo edilizia: le tecniche per gestire la trattativa col cliente senza fare sconti gratis. Ancoraggio, contropartite, BATNA. Guida pratica.",
  excerpt:
  ...
  category: "Vendita",
  tags: ["negoziazione", "trattativa", "prezzo", "vendita", "obiezioni", "preventivi"],
  keyword: "negoziazione prezzo edilizia",
  readingTime: 9,
  ...
  content: `## Come si negozia il prezzo in edilizia senza cedere
...
Se vuoi allenare queste tecniche di negoziazione sul campo, con i tuoi commerciali e sui tuoi preventivi veri, è esattamente il lavoro che facciamo dentro **VENDITA EDILE®**: affiancamento diretto, non teoria da corso. Perché saper trattare senza cedere sul prezzo non è un dono naturale. È un metodo che si allena.`,
  faq: [
    {
      question: "Come si negozia il prezzo con un cliente senza fare sconti?",
      answer:
    ...
    {
      question: "Cosa rispondere quando il cliente dice che ha un preventivo più basso della concorrenza?",
      answer:
    ...
    {
      question: "Perché il silenzio funziona nella negoziazione del prezzo?",
      answer:
    ...
    {
      question: "Cos'è la BATNA e perché serve nella trattativa edile?",
      answer:
    ...
    {
      question: "Quali contropartite si possono offrire al posto di uno sconto sul prezzo?",
      answer:
    ...
    {
      question: "Perché fare subito uno sconto alla prima obiezione danneggia la trattativa futura?",
      answer:
