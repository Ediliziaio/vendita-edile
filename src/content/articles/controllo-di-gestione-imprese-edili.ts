...
const article: Article = {
  ...
  title: "Controllo di gestione per imprese edili: la guida per chi fattura tanto e resta senza margine",
  metaTitle: "Controllo di Gestione Edilizia: Guida per Imprese 2026",
  metaDescription:
    "Controllo di gestione edilizia spiegato semplice: margine per commessa, costi nascosti, cassa e KPI minimi per capire quali lavori ti fanno guadagnare davvero.",
  excerpt:
  ...
  content: `## Perché fatturi tanto e in cassa non resta niente
...
Il controllo di gestione ti dice DOVE stai perdendo margine. Ma trasformare quel margine in fatturato vero passa anche da un'altra leva, spesso trascurata: la capacità di vendere i tuoi preventivi al prezzo giusto, senza scontare per paura di perdere il cliente. È esattamente il lavoro che facciamo in **VENDITA EDILE®**: affiancamento sul campo per imprese edili che vogliono alzare il tasso di chiusura e il margine insieme, non uno a scapito dell'altro. Se hai già i numeri e vuoi anche il sistema di vendita che li protegge, [candidati qui](/#candidati).`,
  faq: [
    ...
    {
      question: "Come si calcola il margine reale di una commessa edile?",
      answer:
    ...
    {
      question: "Perché la mia impresa fattura bene ma resta senza cassa?",
      answer:
    ...
    {
      question: "Quali sono i costi che le imprese edili sottovalutano di più?",
      answer:
    ...
    {
      question: "Quali KPI deve controllare ogni mese un'impresa edile?",
      answer:
    ...
    {
      question: "Che rapporto c'è tra controllo di gestione e prezzo di vendita?",
      answer:
