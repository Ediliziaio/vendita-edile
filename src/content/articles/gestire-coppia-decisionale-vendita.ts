...
const article: Article = {
  slug: "gestire-coppia-decisionale-vendita",
  title: "Coppia decisionale in vendita: come chiudere quando decidono in due",
  metaTitle: "Coppia Decisionale Vendita: Come Chiudere in Due (Guida)",
  metaDescription:
    "Coppia decisionale vendita: come coinvolgere marito e moglie fin dal sopralluogo, scoprire chi decide davvero e chiudere senza il temuto \"ci pensiamo\". Guida pratica.",
  excerpt:
  ...
  content: `## Perché vendere a una coppia è diverso (e perché ti frega quasi sempre)
...
Gestire una coppia decisionale in vendita è una competenza che si allena, non un talento che si ha o non si ha. È esattamente il tipo di lavoro sul campo che facciamo dentro **VENDITA EDILE®**: affianchiamo i tuoi commercianti in trattative vere, con coppie vere, obiezioni vere, non con simulazioni da aula. Se vuoi che il tuo team smetta di perdere preventivi buoni per un "ce lo facciamo sapere" evitabile, candidati e ne parliamo: [/#candidati](/#candidati).`,
  faq: [
    ...
    {
      question: "Come si scopre chi decide davvero in una coppia durante la trattativa?",
      answer:
    ...
    {
      question: "Perché è rischioso fare il preventivo se è presente solo uno dei due coniugi?",
      answer:
    ...
    {
      question: "Come si previene il ne parliamo e ti facciamo sapere in coppia?",
      answer:
    ...
    {
      question: "Cosa fare se al momento della firma manca uno dei due coniugi?",
      answer:
    ...
    {
      question: "Quanto incide la gestione della coppia decisionale sul tasso di chiusura?",
      answer:
