...
const article: Article = {
  ...
  title: "Lead qualificati per imprese edili: come arrivare a 30 richieste al mese",
  metaTitle: "Lead Qualificati Edilizia: Come Arrivare a 30 al Mese",
  metaDescription:
    "Lead qualificati per la tua impresa edile o showroom: i canali giusti, come evitare i contatti spazzatura e un funnel semplice per arrivare a 30 al mese.",
  excerpt:
  ...
  content: `## Cosa sono davvero i lead qualificati per un'impresa edile
...
Generare lead qualificati è il primo passo. Il secondo, quello che fa davvero la differenza sul fatturato, è chiudere i preventivi che ricevi senza abbassare i prezzi. Se hai già un flusso di richieste ma il tasso di chiusura resta basso, è lì che lavoriamo in **VENDITA EDILE®**: affiancamento sul campo, non un corso da guardare. Se vuoi vedere se fa al caso della tua impresa, [candidati qui](/#candidati).`,
  faq: [
    ...
    {
      question: "Quanto costa un lead qualificato nel settore edile in Italia?",
      answer:
    ...
    {
      question: "Quanti lead qualificati servono al mese per un'impresa media?",
      answer:
    ...
    {
      question: "Perché i miei lead non rispondono al telefono o annullano il sopralluogo?",
      answer:
    ...
    {
      question: "Come si fa la qualifica telefonica di un lead prima del sopralluogo?",
      answer:
    ...
    {
      question: "Il referral è davvero un canale di lead qualificati o solo passaparola casuale?",
      answer:
