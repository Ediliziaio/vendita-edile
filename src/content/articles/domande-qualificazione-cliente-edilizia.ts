...
import cover from "@/assets/cover-domande-qualificazione-cliente-edilizia.webp";

const article: Article = {
  slug: "domande-qualificazione-cliente-edilizia",
  title: "Domande di qualificazione cliente in edilizia: fagli dire lui perché deve comprare",
  metaTitle: "Domande di Qualificazione Cliente in Edilizia: Guida",
  metaDescription:
    "Le domande di qualificazione cliente giuste per infissi, fotovoltaico e ristrutturazioni: metodo in 4 fasi con esempi pronti per far emergere il bisogno.",
  excerpt:
  ...
  content: `## Perché le domande di qualificazione cliente valgono più di ogni presentazione
...
Se vuoi che questo metodo diventi parte del modo di vendere della tua impresa, non solo tuo ma di tutto il team commerciale, è esattamente il lavoro che facciamo in **VENDITA EDILE®**: affiancamento sul campo, su trattative vere, con i tuoi venditori e i tuoi clienti. Se vuoi valutare se fa al caso tuo, [candidati qui](/#candidati).`,
  faq: [
    {
      question: "Quali sono le domande di qualificazione cliente più importanti in edilizia?",
      answer:
    ...
    {
      question: "Come si fanno domande di qualificazione senza sembrare invadenti?",
      answer:
    ...
    {
      question: "Perché chi parla troppo durante il sopralluogo vende meno?",
      answer:
    ...
    {
      question: "Quanto tempo si perde senza qualificare bene i clienti?",
      answer:
    ...
    {
      question: "Come si capisce chi decide davvero in una trattativa in edilizia?",
      answer:
    ...
    {
      question: "Le domande di qualificazione funzionano anche per il fotovoltaico?",
      answer:
