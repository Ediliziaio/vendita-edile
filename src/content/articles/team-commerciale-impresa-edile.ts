...
const article: Article = {
  ...
  title: "Come costruire un team commerciale che vende davvero (guida per imprese edili)",
  metaTitle: "Team Commerciale Edilizia: Come Costruirlo Che Vende",
  metaDescription:
    "Come costruire un team commerciale in un'impresa edile che chiude preventivi anche senza di te: selezione, metodo, provvigioni, KPI. Guida pratica.",
  excerpt:
  ...
  content: `## Perché il tuo team commerciale non vende come dovrebbe
...
Se vuoi costruire questo sistema nella tua impresa in modo strutturato, con metodo, script e KPI applicati ai tuoi commerciali reali, è esattamente il lavoro che facciamo dentro **VENDITA EDILE®**: un programma di affiancamento sul campo, non un corso da guardare in differita. [Candidati qui](/#candidati) e parliamo di come costruire il tuo team commerciale.`,
  faq: [
    ...
    {
      question: "Quanto deve guadagnare un venditore in provvigione nel settore edile?",
      answer:
    ...
    {
      question: "Perché i venditori della mia impresa non chiudono come me?",
      answer:
    ...
    {
      question: "Quanto tempo serve per formare un venditore nuovo nel settore infissi o ristrutturazioni?",
      answer:
    ...
    {
      question: "Quali KPI devo monitorare per ogni venditore del team commerciale?",
      answer:
    ...
    {
      question: "Perché sono ancora io l'unico che chiude i preventivi importanti in azienda?",
      answer:
