...
const article: Article = {
  slug: "chiudere-trattativa-serramenti",
  title: "Come chiudere una trattativa di serramenti (in showroom o a casa del cliente)",
  metaTitle: "Chiudere Trattativa Serramenti: Guida Pratica 2025",
  metaDescription:
    "Come chiudere una trattativa di serramenti senza sconti: fasi, diagnosi, domande di chiusura e urgenza reale. La guida pratica per showroom e sopralluoghi.",
  excerpt:
  ...
  cover,
  keyTakeaways: [
    "Chiudere una trattativa di serramenti è un processo in cinque fasi: qualifica, diagnosi, presentazione a valore, chiusura con urgenza reale e follow-up, non un colpo di fortuna a fine appuntamento.",
    "La diagnosi del bisogno va fatta prima di parlare di prezzo: capire perché il cliente è lì (freddo, rumore, bolletta, estetica) cambia tutta la presentazione successiva.",
    "Il momento giusto per chiedere la firma è subito dopo il primo segnale di acquisto, non alla fine della presentazione: continuare a parlare dopo quel segnale raffredda la trattativa.",
    "Il ci penso quasi sempre nasconde un dubbio preciso (prezzo, tempi, conferma di un partner): va fatto emergere con una domanda diretta, non accettato come risposta finale.",
    "Coinvolgere entrambe le persone della coppia decisionale fin dalla prima telefonata riduce drasticamente i ci penso legati al devo sentire mio marito o mia moglie.",
  ],
  content: `## Come si chiude una trattativa di serramenti: la risposta in breve
...
|---|---|---|
| Aggancio e qualifica | Capire se il cliente ha un problema reale, un budget e il potere di decidere | Fissare il sopralluogo a chiunque chiami, senza filtrare |
| Diagnosi del bisogno | Far emergere il vero motivo del cambio infissi (freddo, rumore, bolletta, estetica) | Misurare e basta, senza fare domande |
| Presentazione a valore | Mostrare il preventivo come soluzione al problema emerso, non come lista prezzi | Elencare caratteristiche tecniche (camere, profilo, vetro) senza tradurle in benefici |
| Chiusura e urgenza | Fare le domande giuste e dare un motivo reale per decidere ora | Aspettare che sia il cliente a chiedere di firmare |
| Follow-up | Recuperare i "ci penso" con contatti a valore, non con solleciti vuoti | Mandare il preventivo su WhatsApp e sparire |
...
- Prima del sopralluogo, chiedi al telefono chi altro decide in casa e organizza l'incontro con entrambi presenti.
- Apri ogni appuntamento con tre domande di diagnosi prima di parlare di prezzo o prodotto.
- Riscrivi il tuo preventivo standard traducendo ogni voce tecnica in un beneficio legato al problema del cliente.
- Prepara in anticipo due o tre domande di chiusura da usare al primo segnale di acquisto.
- Individua l'urgenza reale del cliente (listino, tempi di produzione, bonus fiscale) e portala nella conversazione, senza inventarla.

Fai solo questo per le prossime venti trattative e il tuo tasso di chiusura si sposta, in modo misurabile.

Se vuoi che questo diventi un sistema stabile per te e per i tuoi commerciali, non un'intuizione da ripetere a memoria, è esattamente il lavoro che facciamo dentro **VENDITA EDILE®**: affiancamento sul campo, trattativa per trattativa, non un corso da guardare una volta e dimenticare. Perché chiudere una trattativa di serramenti non dipende dal carisma del venditore. Dipende dal metodo che segue. Se vuoi vedere se fa al caso della tua impresa, [candidati qui](/#candidati).`,
  faq: [
    {
      question: "Come si chiude una trattativa di serramenti senza fare sconti?",
      answer:
    ...
    {
      question: "Come si gestisce il ci penso in una trattativa di serramenti?",
      answer:
    ...
    {
      question: "Quando è il momento giusto per chiedere la firma?",
      answer:
    ...
    {
      question: "Come si coinvolge la coppia decisionale nella trattativa serramenti?",
      answer:
    ...
    {
      question: "Come si crea urgenza reale in una trattativa di infissi senza sembrare finti?",
      answer:
    ...
    {
      question: "Meglio chiudere la trattativa in showroom o a casa del cliente?",
      answer:
