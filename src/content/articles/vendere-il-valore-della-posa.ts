...
import cover from "@/assets/cover-vendere-il-valore-della-posa.webp";

const article: Article = {
  slug: "vendere-il-valore-della-posa",
  title: "Vendere la posa infissi: come trasformarla nella tua arma di differenziazione",
  metaTitle: "Vendere la Posa Infissi: la Leva che Batte i Prezzi Bassi",
  metaDescription:
    "Come vendere la posa infissi come valore reale e non come voce nascosta nel preventivo. La leva che ti fa vincere contro i concorrenti più economici.",
  excerpt:
  ...
  content: `## Perché vendere la posa infissi è la leva che i tuoi concorrenti non usano
...
Se vuoi che questo diventi un metodo strutturato per te e per i tuoi commerciali, applicato ai tuoi preventivi veri, è quello che facciamo dentro **VENDITA EDILE®**: affiancamento sul campo, non teoria da corso. Vendere la posa infissi non è un trucco retorico, è la differenza tra competere sul prezzo e competere sul valore.`,
  faq: [
    {
      question: "Come si vende la posa infissi senza sembrare che si stia solo giustificando un prezzo alto?",
      answer:
    ...
    {
      question: "Perché un infisso di buona qualità può comunque dare problemi di condensa o muffa?",
      answer:
    ...
    {
      question: "Cos'è la norma UNI 11673 e serve davvero saperla per vendere?",
      answer:
    ...
    {
      question: "Quanto costa in più una posa qualificata rispetto a una posa economica?",
      answer:
    ...
    {
      question: "Come faccio a dimostrare al cliente che la mia posa è migliore di quella del concorrente?",
      answer:
    ...
    {
      question: "Conviene avere una squadra di posa interna invece di subappaltare?",
      answer:
