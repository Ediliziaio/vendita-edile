...
const article: Article = {
  ...
  title: "Chiudere al primo appuntamento: come firmare senza il giro infinito di preventivi",
  metaTitle: "Chiudere al Primo Appuntamento: la Guida Pratica 2026",
  metaDescription:
    "Come chiudere al primo appuntamento invece di rincorrere preventivi per settimane: preparazione, struttura, urgenza etica e chiusura. Guida operativa.",
  excerpt:
  ...
  content: `## Perché devi chiudere al primo appuntamento (e non "mandare un preventivo")
...
Se vuoi costruire questo sistema di chiusura dentro la tua azienda, con i tuoi venditori e i tuoi appuntamenti veri, è quello che facciamo in **VENDITA EDILE®**: affiancamento sul campo per portare il tasso di chiusura al primo appuntamento dove deve stare, senza abbassare i prezzi. Perché chiudere al primo appuntamento non è fortuna. È un metodo che si allena.`,
  faq: [
    {
      question: "Come si fa a chiudere al primo appuntamento nel settore infissi e serramenti?",
      answer:
    ...
    {
      question: "Perché più preventivi mando e più il cliente si raffredda?",
      answer:
    ...
    {
      question: "Quanto conviene fare uno sconto per chiudere subito al primo appuntamento?",
      answer:
    ...
    {
      question: "Come si crea urgenza vera senza sembrare un venditore aggressivo?",
      answer:
    ...
    {
      question: "Cosa fare se al primo appuntamento manca il decisore per firmare subito?",
      answer:
    ...
    {
      question: "Perché tanti venditori non riescono a chiedere direttamente la firma?",
      answer:
