...
const article: Article = {
  ...
  title: "Come fare preventivi edilizia che chiudono (e non finiscono nel dimenticatoio)",
  metaTitle: "Come Fare Preventivi Edilizia Che Chiudono: Guida 2026",
  metaDescription:
    "Come fare preventivi edilizia che il cliente firma davvero: struttura, fasce di prezzo, ancoraggio e consegna. La guida pratica per infissi e ristrutturazioni.",
  excerpt:
  ...
  cover,
  keyTakeaways: [
    "Un preventivo edile che chiude non è un elenco di materiali: è un documento che presenta un risultato, con voci chiare e un prezzo ancorato correttamente.",
    "Strutturare il preventivo in 3 fasce (buono, migliore, ottimo) aumenta sia il tasso di chiusura sia lo scontrino medio, perché sposta la domanda da comprare o no a quale opzione scegliere.",
    "Mandare un PDF-lenzuolo su WhatsApp senza spiegarlo è uno dei modi più veloci per perdere una trattativa già vinta sul sopralluogo.",
    "Consegnare il preventivo a voce, di persona o in videochiamata, entro 48-72 ore dal sopralluogo, moltiplica il tasso di chiusura rispetto a un invio muto via email.",
    "Il preventivo non è un documento statico: è l'inizio di un follow-up strutturato che decide la maggior parte delle firme.",
  ],
  content: `## Perché il tuo preventivo non chiude (anche se il prezzo è giusto)
...
- **Buono**: la soluzione essenziale, di qualità corretta ma senza extra. Serve come punto di riferimento basso, spesso non è la più scelta ma rende le altre due più accessibili al confronto.
- **Migliore**: la soluzione che consigli davvero, quella con il miglior rapporto tra prestazioni e prezzo. È la fascia che nella maggior parte dei casi diventa la scelta naturale del cliente, e va costruita apposta per esserlo.
- **Ottimo**: la soluzione top di gamma, con materiali o finiture superiori. Anche se pochi la scegliono, alza il valore percepito delle altre due e intercetta i clienti che vogliono il massimo.
...
| Modalità di consegna preventivo | Tasso di chiusura medio |
|---|---|
| PDF via WhatsApp, nessuna spiegazione | 8-12% |
| PDF via email + follow-up telefonico generico | 15-20% |
| Consegna a voce (persona o video) senza fasce di prezzo | 20-28% |
| Consegna a voce + 3 fasce + follow-up strutturato a 48-72h | 35-45% |
...
Non serve rifare tutti i tuoi modelli di preventivo in un giorno. Parti da qui:

- Riscrivi l'intestazione del prossimo preventivo partendo dal problema del cliente, non dall'elenco materiali.
- Raggruppa le voci per ambiente o fase lavoro, non in un'unica lista lunga.
- Costruisci le tue prime tre fasce buono-migliore-ottimo su un intervento tipo (infissi o bagno) e riusale come base.
- Il prossimo preventivo non mandarlo: chiama il cliente e fissa 10 minuti per ripassarlo insieme, dall'opzione più alta a quella più bassa.
- Metti in agenda un follow-up a 48-72 ore su ogni preventivo consegnato da oggi in poi.

Fai solo questi cinque passaggi sui prossimi dieci preventivi e vedrai il tasso di chiusura muoversi, senza aver toccato un prezzo.

Se vuoi il sistema completo per strutturare, presentare e far chiudere i preventivi della tua impresa, applicato ai tuoi commerciali e ai tuoi cantieri reali, è quello che facciamo dentro **VENDITA EDILE®**: affiancamento sul campo, non teoria da corso. Perché un preventivo che chiude non è questione di fortuna o di prezzo basso. È questione di metodo.`,
  faq: [
    {
      question: "Come si fa un preventivo edilizia che il cliente firma subito?",
      answer:
    ...
    {
      question: "Quanto tempo dopo il sopralluogo va consegnato il preventivo?",
      answer:
    ...
    {
      question: "Perché conviene proporre tre fasce di prezzo invece di una sola?",
      answer:
    ...
    {
      question: "Perché il preventivo mandato via WhatsApp non funziona?",
      answer:
    ...
    {
      question: "Cosa significa ancorare il prezzo in un preventivo edile?",
      answer:
    ...
    {
      question: "Il follow-up dopo il preventivo serve davvero o basta aspettare la risposta?",
      answer:
