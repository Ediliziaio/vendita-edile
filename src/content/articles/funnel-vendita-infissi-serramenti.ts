...
import cover from "@/assets/cover-funnel-vendita-infissi-serramenti.webp";

const article: Article = {
  slug: "funnel-vendita-infissi-serramenti",
  title: "Funnel di vendita per infissi e serramenti: dal lead al contratto firmato",
  metaTitle: "Funnel Vendita Infissi e Serramenti: Guida Completa",
  metaDescription:
    "Il funnel vendita edilizia per infissi e serramenti: le 7 fasi, i KPI da misurare, i tassi di conversione realistici e dove si perdono i clienti. Guida pratica.",
  excerpt:
  ...
  content: `## Cos'è un funnel di vendita per infissi e serramenti (e perché ti serve)
...
Un **funnel vendita edilizia** chiaro elimina il "vado a sensazione". Non aggiungi marketing, non abbassi i prezzi: sistemi le fasi dove oggi stai regalando fatturato senza saperlo. È esattamente il lavoro che facciamo dentro **VENDITA EDILE®**: mappiamo il tuo funnel reale, troviamo il collo di bottiglia e mettiamo un sistema, non teoria, dentro la tua azienda. Se vuoi vedere se il tuo funnel ha i buchi che abbiamo descritto qui, candidati e ne parliamo: [vendita-edile.it/#candidati](/#candidati).`,
  faq: [
    {
      question: "Come si costruisce un funnel di vendita per infissi e serramenti?",
      answer:
    ...
    {
      question: "Qual è il tasso di chiusura medio dei preventivi infissi?",
      answer:
    ...
    {
      question: "Perché perdo clienti dopo aver mandato il preventivo?",
      answer:
    ...
    {
      question: "Quanti follow-up servono prima di chiudere un preventivo?",
      answer:
    ...
    {
      question: "Quali KPI devo monitorare nel funnel vendita edilizia?",
      answer:
    ...
    {
      question: "Le automazioni sostituiscono il commerciale nel funnel di vendita?",
      answer:
