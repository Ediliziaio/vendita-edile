...
import cover from "@/assets/cover-kpi-vendita-edilizia-numeri.webp";

const article: Article = {
  slug: "kpi-vendita-edilizia-numeri",
  title: "KPI vendita edilizia: i numeri che ogni impresa deve misurare per crescere",
  metaTitle: "KPI Vendita Edilizia: i 7 Numeri da Monitorare | Guida",
  metaDescription:
    "KPI vendita edilizia: i 7 numeri da misurare ogni mese (tasso di chiusura, ticket medio, follow-up) per far crescere il fatturato senza sconti. Guida pratica.",
  excerpt:
  ...
  content: `## Quali sono i KPI di vendita che un'impresa edile deve davvero misurare
...
Chi non misura questi numeri vende a sensazione, e la sensazione non fa crescere il fatturato. Se vuoi mettere questi KPI di vendita edilizia al centro della tua azienda, con un sistema costruito da chi vende infissi, serramenti e ristrutturazioni ogni giorno e non da formatori da aula, è quello che facciamo dentro **VENDITA EDILE®**: affiancamento vero, sui tuoi numeri, sulla tua squadra. Candidati qui: [/#candidati](/#candidati).`,
  faq: [
    ...
    {
      question: "Come si calcola il tasso di chiusura dei preventivi?",
      answer:
    ...
    {
      question: "Quanto vale in media un contratto di infissi o ristrutturazione?",
      answer:
    ...
    {
      question: "Perché il tasso di follow-up è un KPI di vendita così importante?",
      answer:
    ...
    {
      question: "Quanto tempo impiega in media un preventivo a diventare contratto?",
      answer:
