...
const article: Article = {
  ...
  title: "Primo contatto telefonico: come gestire i lead in edilizia senza bruciarli",
  metaTitle: "Gestire Lead al Telefono in Edilizia: Guida Pratica 2026",
  metaDescription:
    "Come gestire lead al telefono nell'edilizia: perché la prima chiamata brucia i contratti, cosa dire e cosa non dire, e come portare a casa il sopralluogo.",
  excerpt:
  ...
  content: `## Perché la maggior parte dei lead si brucia nella prima telefonata
...
Se vuoi che questo diventi un sistema stabile, applicato ai tuoi commerciali e non lasciato al talento del singolo, è quello che costruiamo dentro **VENDITA EDILE®**: affiancamento sul campo sulla gestione dei lead, dalla prima telefonata alla firma del contratto. Candidati qui: [/#candidati](/#candidati).`,
  faq: [
    {
      question: "Come si gestisce un lead al telefono in edilizia senza perderlo?",
      answer:
    ...
    {
      question: "Perché è importante rispondere subito a un lead in edilizia?",
      answer:
    ...
    {
      question: "Cosa rispondere quando il cliente chiede quanto costa al telefono?",
      answer:
    ...
    {
      question: "Quanto tempo deve durare la prima telefonata con un lead?",
      answer:
    ...
    {
      question: "Perché conviene fissare il sopralluogo invece di mandare subito il preventivo?",
      answer:
    ...
    {
      question: "Come si qualifica velocemente un lead in edilizia al telefono?",
      answer:
