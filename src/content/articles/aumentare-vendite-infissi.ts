...
const article: Article = {
  ...
  title: "Come aumentare le vendite di infissi e serramenti (senza abbassare i prezzi)",
  metaTitle: "Aumentare Vendite Infissi e Serramenti: Guida 2026",
  metaDescription:
    "Come aumentare le vendite di infissi e serramenti senza fare sconti: il sistema in 5 fasi che usano le imprese edili che chiudono di più. Guida pratica.",
  excerpt:
  ...
  content: `## Perché non riesci ad aumentare le vendite di infissi (anche se lavori tanto)
...
Se vuoi il sistema completo, applicato alla tua azienda e ai tuoi commerciali, è esattamente quello che facciamo in **VENDITA EDILE®**: affiancamento sul campo, non un corso da guardare. Perché aumentare le vendite di infissi non è questione di talento. È questione di metodo.`,
  faq: [
    {
      question: "Come si aumentano le vendite di infissi senza fare sconti?",
      answer:
    ...
    {
      question: "Qual è il tasso di chiusura medio di un'impresa di infissi?",
      answer:
    ...
    {
      question: "Il prezzo è davvero il motivo per cui perdo i clienti?",
      answer:
    ...
    {
      question: "Quanto tempo serve per vedere risultati sulle vendite?",
      answer:
