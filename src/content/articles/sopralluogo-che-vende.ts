...
const article: Article = {
  slug: "sopralluogo-che-vende",
  title: "Sopralluogo che vende: come trasformare la visita in casa nella tua arma migliore",
  metaTitle: "Sopralluogo Vendita Infissi: la Guida per Chiudere di Più",
  metaDescription:
    "Il sopralluogo vendita infissi non è prendere le misure: è dove vinci o perdi la trattativa. Scopri cosa osservare, chiedere e fare in casa del cliente.",
  excerpt:
  ...
  category: "Vendita",
  tags: ["sopralluogo", "infissi", "serramenti", "vendita", "trattativa", "preventivi"],
  keyword: "sopralluogo vendita infissi",
  readingTime: 9,
  ...
  content: `## Perché il sopralluogo vendita infissi decide la trattativa prima ancora del preventivo
...
Se vuoi portare questo metodo in tutta la tua squadra commerciale, con affiancamento reale sul campo e non solo teoria, è esattamente quello che facciamo in **VENDITA EDILE®**: entriamo nei tuoi sopralluoghi, nelle tue trattative vere, e costruiamo insieme il sistema che fa alzare il tasso di chiusura senza abbassare i prezzi. Il sopralluogo che vende non è un talento naturale. È un metodo che si allena.`,
  faq: [
    {
      question: "Come si trasforma il sopralluogo infissi in un momento di vendita?",
      answer:
    ...
    {
      question: "Quali domande fare durante il sopralluogo vendita infissi?",
      answer:
    ...
    {
      question: "Quanto deve durare un sopralluogo per vendere davvero infissi e serramenti?",
      answer:
    ...
    {
      question: "Perché il sopralluogo è più importante del preventivo scritto?",
      answer:
    ...
    {
      question: "Come si fa emergere il budget del cliente senza sembrare invadenti?",
      answer:
    ...
    {
      question: "Cosa dire al cliente prima di lasciare la casa dopo il sopralluogo?",
      answer:
