...
import cover from "@/assets/cover-marketing-per-imprese-edili-guida.webp";

const article: Article = {
  slug: "marketing-per-imprese-edili-guida",
  title: "Marketing per imprese edili: la guida pratica per chi parte da zero",
  metaTitle: "Marketing per Imprese Edili: Guida Pratica 2026",
  metaDescription:
    "Marketing per impresa edile: profilo Google, passaparola, ads locali, sito che converte. La guida pratica per chi parte da zero e vuole più preventivi seri.",
  excerpt:
  ...
  content: `## Da dove parte davvero il marketing di un'impresa edile
...
Il marketing porta le persone alla porta. Ma se poi in trattativa perdi 7 preventivi su 10, il marketing da solo non ti salva il fatturato. È esattamente il pezzo che manca a molte imprese edili, ed è quello su cui lavoriamo dentro **VENDITA EDILE®**: un affiancamento sul campo per alzare il tasso di chiusura dei preventivi che il tuo marketing già ti porta, senza abbassare i prezzi. Se vuoi vedere se fa al caso tuo, candidati qui: [scopri come funziona](/#candidati).`,
  faq: [
    {
      question: "Come si fa marketing per un'impresa edile che parte da zero?",
      answer:
    ...
    {
      question: "Quanto costa fare marketing per un'impresa edile?",
      answer:
    ...
    {
      question: "Meglio Google Ads o Meta Ads per un'impresa edile?",
      answer:
    ...
    {
      question: "Perché il passaparola da solo non basta più?",
      answer:
    ...
    {
      question: "Perché genero lead con il marketing ma non chiudo contratti?",
      answer:
    ...
    {
      question: "Quanto tempo serve per vedere risultati dal marketing di un'impresa edile?",
      answer:
